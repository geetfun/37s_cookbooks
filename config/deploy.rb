...
task :bootstrap do
  run "apt-get update"
  run "DEBCONF_TERSE='yes' DEBIAN_PRIORITY='critical' DEBIAN_FRONTEND=noninteractive apt-get -qyu install emacs22-nox vim git-core mysql-client libshadow-ruby1.8 libmysqlclient15-dev build-essential syslog-ng ntp ruby ruby1.8-dev libopenssl-ruby1.8 irb rdoc ri rubygems man-db rake curl"
  install_rubygems
